...
>
> **Claude session protocol:** At the start of each session, read local files via MCP to check current state. When any canon is added or changed during a session, update the relevant file(s) in D:\Kaleb\halden-city-wiki\ using the Filesystem tools, then prompt Kaleb to commit and push via GitHub Desktop.
...
| **The Ironworks** | Post-industrial. Shuttered factories, active shipyards. Persico's crime network. Law feels thinner here. **The Hall** (player HQ) is on the Ironworks/Riverside border. |
...
**Player HQ:** The Hall — former Ironworkers' Local 44 union hall, corner of Dolan and Renner (Ironworks/Riverside border). Alliance satellite. Three floors: training + equipment (G/F), Arachne's comms suite (2/F), undeveloped with six boxes of Local 44 records 1938+ and one locked room of unknown provenance (3/F). Union seal in entry floor. Tomás Reyes and Father Wróbel have noticed activity.
...
Early investing partner in Eclipse's PROMETHEUS program — knowing participant, ideological true believer.
...
### Avi Park / Nova
PC. Full profile: `characters/pcs/avi-park-nova.md`. Do not over-document internal states — creative ownership belongs to the player. Javier Mendez (Quantum) is his biological father; they are on the same team without Avi's knowledge. Carter Williams / Renegade Force has personal history tied to Avi's backstory. Avi does not know about the Carter/Avi connection. Riley and Signal both do.
...
### Casper Curie / Half-Life
PC. Full profile: `characters/pcs/casper-curie-half-life.md`.

---

## Characters — NPCs: The Alliance & Network
...
Son of Sandra Vega — Riley's defining guilt. Grew up without her. Found Riley, asked to be trained. Where Riley fights from guilt, Adrian fights from clarity. Most tactically precise partnership in the Alliance network. Currently dating Casey Holt / Scythe — approximately two months at campaign start.
...
Powers: Kinetic absorption and redistribution — incoming force doesn't hurt her; she can send it back proportionally. Manifested during a building fire. Genuinely warm, no armor. Riley relaxes around her in ways that register with Avi as a quiet wound.
...
## Characters — NPCs: A.E.G.I.S. Assets
...
| Arc | Central Question | Anticipated End State |
|---|---|---|
| **Arc 1 — Institutions Questioned** | Should these institutions exist? | Signal engineers removal of both cosmic Forces. Alliance fractured and delegitimized. |
| **Arc 2 — Life Without the Old Institutions** | What fills the vacuum when they collapse? | A.E.G.I.S. turns on uncontrolled supers. Heroes hunted by the people they protected. |
| **Arc 3 — The Auditors (short)** | Does Earth deserve to survive without its guarantor? | Auditors fail/retreat. How they retreat seeds Arc 4. Starfall's arc is load-bearing. |
| **Arc 4 — The New System** | Who has the right to build what comes next? | Antagonist with correct diagnosis, flawed execution. Darkstar is primary candidate. |
...
| `factions/eclipse.md` | Eclipse — public face and PROMETHEUS black program |
...
| `meta/naming-conventions.md` | Naming patterns and conventions |
