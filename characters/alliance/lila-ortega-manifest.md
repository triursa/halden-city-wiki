...
| Field | Value |
|---|---|
| **Full Name** | Lila Ortega |
| **Age** | 39 |
| **Role** | MANIFEST Director — A.E.G.I.S. Halden Regional Command |
| **A.E.G.I.S. Division** | MANIFEST — Youth Manifestation & Intervention Program |
| **Reports To** | Regional Director Evelyn Shaw |
| **Status** | Active — in lockdown alongside rest of A.E.G.I.S. post-Session 1 hack |
| **Team Influence** | Yes — saved by players at Session 1 press conference |
...
| Person | Relationship |
|---|---|
| **Evelyn Shaw** | Director and supervisor. Professional respect, careful navigation. Shaw is not hostile to Lila's approach but will override it without hesitation if the institutional calculus shifts. |
| **The team** | Personal debt, professional complication. She is watching them more closely now — not as a threat, as a concern. The distinction matters to her. |
| **Adrian Vega / Breakpoint** | Active MANIFEST file. She has not pushed. She is still not pushing. But she is paying attention. |
...
- [A.E.G.I.S. Regional Command](../../../locations/aegis-halden-regional-command.md) — MANIFEST assessment suite, sub-level 3
- [A.E.G.I.S. Faction File](../../../factions/aegis.md) — division overview
- [Casey Holt / Scythe](../npcs/casey-holt-scythe.md) — [GM ONLY] MANIFEST asset Lila doesn't know exists
- [Adrian Vega / Breakpoint](../alliance/adrian-vega-breakpoint.md) — active MANIFEST file

---

*Last updated: March 2026*
*File created post-Session 1. Team influence established. Lockdown constraints noted.*
