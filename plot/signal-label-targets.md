...
> Reference for GM use during "Who Decides."
> Signal's broadcasts are mechanically "tell them who they are" moves. Each reveal has a primary target and a ripple effect on the rest of the team watching.
> Apply shifts after the broadcast lands — not during. Let the fiction settle first.
...
**Primary Target: The whole team equally.**
This reveal doesn't have a single PC target — it strips legitimacy from the structure every PC has been operating inside. Apply ripple to all.
